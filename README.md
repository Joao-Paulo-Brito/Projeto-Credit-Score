...
* **Análise preditiva**: Após o treninamento do modelo e da análise de seu desempenho, foram feitas 5 perguntas que tem o objetivo de verificar quais variáveis tem maior peso na análise preditiva, como por exemplo se o número de filhos poderá alterar a classificação de crédito de uma pessoa, perguntas nesse sentido, para que os modelos possam extrair as informações necessárias para responder as 5 perguntas.
